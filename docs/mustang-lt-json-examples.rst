...
See the source file 
`PresetCanonicalSerializer.java<https://github.com/tim-littlefair/feral-horse-amp-utils/blob/main/lib/src/main/java/net/heretical_camelid/fhau/lib/registries/PresetCanonicalSerializer.java>`_
